...
const BASE_REVIEW = [
	...
	"### duplication",
	"- status: ok",
	"- evidence: The task diff adds one validation branch with no repeated block.",
	"- action: No extraction.",
	"",
	"### naming",
	"- status: ok",
	"- evidence: Touched names match existing parser terminology.",
	"- action: Keep names.",
	"",
	"### control_flow",
	"- status: ok",
	"- evidence: The branch uses the existing validation return path.",
	"- action: Keep flow.",
	"",
	"### abstraction_level",
	"- status: ok",
	"- evidence: A helper would wrap one condition.",
	"- action: Reject helper extraction.",
	"",
	"### hidden_coupling",
	"- status: not_applicable",
	"- evidence: No shared mutable state or callback boundary changed.",
	"- action: No action.",
	"",
	"### error_handling",
	"- status: ok",
	"- evidence: Existing typed error path is reused.",
	...
	"### debug_leftovers",
	"- status: ok",
	"- evidence: Diff has no temporary logs or scratch files.",
	"- action: No cleanup.",
	"",
	"### scope_creep",
	"- status: ok",
	"- evidence: Changed file belongs to the task scope.",
	"- action: No scope reduction.",
	"",
	"## Refactor Decision",
	"Decision: kept",
	"",
