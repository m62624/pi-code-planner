...
export async function buildPlannerStatusText(
	...
	lines.push(
		...
		"",
		"## Languages",
		`- human: ${settings.effective.metadata.humanLanguage}`,
		`- title: ${settings.effective.metadata.titleLanguage}`,
		`- description: ${settings.effective.metadata.descriptionLanguage}`,
		`- commit: ${settings.effective.metadata.commitLanguage}`,
		`- doubtReview: ${settings.effective.metadata.doubtReviewLanguage}`,
		`- skill: ${settings.effective.metadata.skillLanguage}`,
		"",
		"## Git",
