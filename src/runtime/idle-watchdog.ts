...
export function buildPlannerIdleWakeMessage(input: {
	...
	return [
		...
		"If you are stuck, do not repeat the same attempt. Inspect logs, git diff/stat, and focused test/build output, then call planner_report_stuck with the evidence and next debug plan.",
		"",
